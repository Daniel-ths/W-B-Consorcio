...
export default function Navbar() {
  ...
  return (
    <>
        {/* --- NAVBAR PRINCIPAL --- */}
        {/* MUDANÇA 1: z-[1001] garante que ela fique ACIMA do menu que vai abrir */}
...
{/* --- MEGA MENU VEÍCULOS --- */}
        {/* Mudei de top-16 para top-[60px] para ele subir e colar na barra */}
        ...
        {/* Overlay Escuro (Fica atrás do menu e da nav) */}
        {menuAberto && (
            <div 
