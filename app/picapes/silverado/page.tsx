...
const CONFIG = {
  ...
  stats: [
    { value: "V8", unit: "", label: "Potência e torque", icon: <Gauge size={18} /> },
    { value: "4x4", unit: "", label: "Tração e capacidade", icon: <CarFront size={18} /> },
    { value: "Tech", unit: "", label: "Conectividade premium", icon: <MonitorSmartphone size={18} /> },
    { value: "Safety", unit: "", label: "Assistências e segurança", icon: <ShieldCheck size={18} /> },
  ],

  // ⚠️ TROQUE pelas suas imagens do Supabase
  heroImage:
    "https://qkpfsisyaohpdetyhtjd.supabase.co/storage/v1/object/public/cars/caminhonete/silverado/galeria-aberta-1.avif",

  sectionImage:
    "https://qkpfsisyaohpdetyhtjd.supabase.co/storage/v1/object/public/cars/caminhonete/silverado/galeria-aberta-6.avif",   
  sectionTitle: "A picape grande que impõe respeito.",
  sectionText:
    "A Silverado combina presença, tecnologia e capacidade. Simule consórcio ou financiamento com atendimento rápido e transparente.",
    ...
    colors: [
      {
        name: "Prata shark",
        hex: "#b9b9b9",
        img: "https://qkpfsisyaohpdetyhtjd.supabase.co/storage/v1/object/public/cars/caminhonete/silverado/pra.png",
      },
      {
        name: "Preto ouro"  ,
        hex: "#3b3b3b",
        img: "https://qkpfsisyaohpdetyhtjd.supabase.co/storage/v1/object/public/cars/caminhonete/silverado/pre.png",
      },
      {
        name: "Vermelho Scarlet",
        hex: "#6d0703",
        img: "https://qkpfsisyaohpdetyhtjd.supabase.co/storage/v1/object/public/cars/caminhonete/silverado/ver.png",
      },
    ],
  },
  interior: {
  ...
  benefits: [
    { icon: <CarFront size={18} />, title: "4x4", desc: "capacidade e tração" },
    { icon: <ShieldCheck size={18} />, title: "Segurança", desc: "assistências avançadas" },
    { icon: <MonitorSmartphone size={18} />, title: "Tecnologia", desc: "conectividade premium" },
    { icon: <Wrench size={18} />, title: "Robustez", desc: "estrutura e durabilidade" },
  ],
};
