...
/**
 * S10 — com FINALIZAÇÃO no final (mesma lógica)
...
const CONFIG = {
  ano: "2026",
  titulo: "S10 LTZ", // "S10 High Country"
  subtitulo: "Picape forte de verdade • Simule em minutos",

  // ✅ PREÇO S10
  priceStart: 280000, // R$ 282.990

  ctaHero: "Simular agora",
  ctaSecondary: "Solicitar contato",

  stats: [
    { value: "2.8", unit: "Turbo", label: "Duramax (diesel)", icon: <Gauge size={18} /> },
    { value: "4x4", unit: "", label: "Tração para qualquer terreno", icon: <CarFront size={18} /> },
    { value: "MyLink", unit: "", label: "Conectividade e multimídia", icon: <MonitorSmartphone size={18} /> },
    { value: "Safety", unit: "", label: "Assistências e segurança", icon: <ShieldCheck size={18} /> },
  ],

  heroImage: "https://qkpfsisyaohpdetyhtjd.supabase.co/storage/v1/object/public/cars/s10/galeria-01.avif",

  sectionImage: "https://qkpfsisyaohpdetyhtjd.supabase.co/storage/v1/object/public/cars/s10/galeria-02.avif",
  sectionTitle: "Pronta para o trabalho. Perfeita para o dia a dia.",
  sectionText:
    "A S10 une robustez, conforto e tecnologia. Simule consórcio ou financiamento com atendimento rápido e humano.",

  gallery: [
    "https://qkpfsisyaohpdetyhtjd.supabase.co/storage/v1/object/public/cars/s10/5.avif",
    "https://qkpfsisyaohpdetyhtjd.supabase.co/storage/v1/object/public/cars/s10/conectividade2.avif",
    "https://qkpfsisyaohpdetyhtjd.supabase.co/storage/v1/object/public/cars/s10/conectividade1.avif",
    "https://qkpfsisyaohpdetyhtjd.supabase.co/storage/v1/object/public/cars/s10/conectividade4.avif",
    "https://qkpfsisyaohpdetyhtjd.supabase.co/storage/v1/object/public/cars/s10/conectividade3.avif",
    "https://qkpfsisyaohpdetyhtjd.supabase.co/storage/v1/object/public/cars/s10/interior-s10.avif",
    "https://qkpfsisyaohpdetyhtjd.supabase.co/storage/v1/object/public/cars/s10/galeria-01.avif",
  ],
    ...
    colors: [
      {
        name: "Branco Summit",
        hex: "#ffffff",
        img: "https://qkpfsisyaohpdetyhtjd.supabase.co/storage/v1/object/public/cars/s10/Branco%20Summit.png",
      },
      {
        name: "Vermelho Scarlet",
        hex: "#ff0000",
        img: "https://qkpfsisyaohpdetyhtjd.supabase.co/storage/v1/object/public/cars/s10/Vermelho%20Scarlet.png",
      },
      {
        name: "Preto",
        hex: "#1f2328",
        img: "https://qkpfsisyaohpdetyhtjd.supabase.co/storage/v1/object/public/cars/s10/Preto%20ouro.png",
      },
    ],
  },
    ...
    colors: [
      {
        ...
        images: [
          "https://qkpfsisyaohpdetyhtjd.supabase.co/storage/v1/object/public/cars/s10/interior-s10.avif",
          "https://qkpfsisyaohpdetyhtjd.supabase.co/storage/v1/object/public/cars/s10/6%20(1).avif",
        ],
      },
    ],
  },
  ...
  benefits: [
    { icon: <CarFront size={18} />, title: "4x4", desc: "capacidade em off-road" },
    { icon: <ShieldCheck size={18} />, title: "Segurança", desc: "assistências e alertas" },
    { icon: <MonitorSmartphone size={18} />, title: "Conectividade", desc: "central multimídia" },
    { icon: <Wrench size={18} />, title: "Robustez", desc: "feita para durar" },
  ],
};
              ...
              <div className="bg-gray-50 rounded-2xl p-6 border border-gray-200">
                ...
                <div className="mt-6 p-4 rounded-xl border border-gray-200 bg-white">
                  ...
                  {CONFIG.priceStart > 0 ? (
                    ...
                    <p className="text-sm text-gray-600 mt-1">Valor sob consulta</p>
                  )}
