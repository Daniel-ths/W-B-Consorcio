...
// --- DADOS E FUNÇÕES (Mantidos / melhorados) ---
const BASE_URL_IMG =
  "https://qkpfsisyaohpdetyhtjd.supabase.co/storage/v1/object/public/cars/logo/";
const LOGO_FILE = "seminovos.png";

const FAQ_ITEMS = [
  {
    question: "Como funciona a avaliação?",
    answer: "A avaliação é feita com base na tabela FIPE e no estado de conservação do veículo.",
  },
  {
    question: "O pagamento é à vista?",
    answer: "Sim, ou usado como entrada na troca por outro veículo.",
  },
  {
    question: "Aceitam carro financiado?",
    answer: "Sim, quitamos o financiamento e pagamos a diferença.",
  },
];

type Brand = { name: string; id: number; file: string };
...
const BRANDS: Brand[] = [
  {
    name: "CHEVROLET",
    id: 23,
    file: "https://qkpfsisyaohpdetyhtjd.supabase.co/storage/v1/object/public/cars/chevrolet-logo.svg",
  },
  {
    name: "VOLKSWAGEN",
    id: 59,
    file: "https://qkpfsisyaohpdetyhtjd.supabase.co/storage/v1/object/public/cars/logo/39-396793_cars-logo-brands-png-images-simbolo-volkswagen-sem-fundo.png",
  },
  {
    name: "RENAULT",
    id: 44,
    file: "https://qkpfsisyaohpdetyhtjd.supabase.co/storage/v1/object/public/cars/logo/pngimg.com%20-%20renault_PNG40.png",
  },
  {
    name: "FORD",
    id: 22,
    file: "https://qkpfsisyaohpdetyhtjd.supabase.co/storage/v1/object/public/cars/logo/images.png",
  },
  {
    name: "HYUNDAI",
    id: 26,
    file: "https://qkpfsisyaohpdetyhtjd.supabase.co/storage/v1/object/public/cars/logo/Hyundai-Logo.png",
  },
  {
    name: "TOYOTA",
    id: 56,
    file: "https://qkpfsisyaohpdetyhtjd.supabase.co/storage/v1/object/public/cars/logo/Toyota-logo.png",
  },
  {
    name: "NISSAN",
    id: 43,
    file: "https://qkpfsisyaohpdetyhtjd.supabase.co/storage/v1/object/public/cars/logo/nissan-6-logo-png-transparent.png",
  },
  {
    name: "HONDA",
    id: 25,
    file: "https://qkpfsisyaohpdetyhtjd.supabase.co/storage/v1/object/public/cars/logo/images%20(1)%20(1).jfif",
  },
  {
    name: "FIAT",
    id: 21,
    file: "https://qkpfsisyaohpdetyhtjd.supabase.co/storage/v1/object/public/cars/logo/fiat-logo-21.png",
  },
  {
    name: "JEEP",
    id: 29,
    file: "https://qkpfsisyaohpdetyhtjd.supabase.co/storage/v1/object/public/cars/logo/Jeep-Logo.png",
  },
  {
    name: "CITROËN",
    id: 11,
    file: "https://qkpfsisyaohpdetyhtjd.supabase.co/storage/v1/object/public/cars/logo/Citroen-Logo-PNG-Clipart.png",
  },
  {
    name: "PEUGEOT",
    id: 41,
    file: "https://qkpfsisyaohpdetyhtjd.supabase.co/storage/v1/object/public/cars/logo/images%20(2).jfif",
  },
];
...
const cleanCurrency = (value: string) =>
  !value ? "0" : value.replace(/\D/g, "").replace(/(\d{2})$/, ".$1");
...
export default function SeminovosPage() {
  ...
  const modelsCache = useRef<Record<number, FipeModel[]>>({});
  ...
  const handleBrandSelect = async (brand: Brand) => {
    ...
    // abort fetch anterior (evita corrida)
    ...
    try {
      const res = await fetch(
        `https://parallelum.com.br/fipe/api/v1/carros/marcas/${brand.id}/modelos`,
        { signal: controller.signal }
      );
      const data = await res.json();
      const listaModelos: FipeModel[] = data?.modelos || [];
      modelsCache.current[brand.id] = listaModelos;
      setModelos(listaModelos);
    } catch (error: any) {
      if (error?.name !== "AbortError") console.error("Erro FIPE", error);
    } finally {
  ...
  // ✅ agora "Financeiro" é realmente opcional
        ...
        <div className="max-w-7xl mx-auto flex flex-col gap-4">
            ...
            <div className="flex items-center gap-3">
              {selectedBrand && (
                <button
                  ...
                  className="bg-black/10 p-2 rounded-full hover:bg-black hover:text-white transition-colors"
                  aria-label="Voltar"
                >
                  <ArrowLeft size={20} />
                </button>
          ...
          {!selectedBrand && (
            <div className="relative w-full group mt-2">
              <input
                type="text"
                placeholder="Buscar marca do carro..."
                value={searchTerm}
        ...
        {!selectedBrand ? (
          <div className="animate-in fade-in slide-in-from-bottom-4 duration-700">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-4">
              {filteredBrands.map((brand) => (
                ...
                >
                  ...
                  <span className="font-bold text-gray-900 text-[10px] uppercase tracking-widest bg-gray-50 px-2 py-1 rounded-md group-hover:bg-[#f2e14c] transition-colors">
                    {brand.name}
                  </span>
                </button>
              ))}
            ...
            <div className="mt-12 bg-white rounded-3xl p-6 shadow-sm border border-gray-100">
              <h3 className="font-black text-lg uppercase mb-4 flex items-center gap-2">
                <span className="bg-[#f2e14c] w-8 h-8 flex items-center justify-center rounded-full text-black">
                  ?
                </span>
                Dúvidas Comuns
              </h3>
                ...
                {FAQ_ITEMS.map((item, i) => (
                  <div key={i} className="border-b border-gray-100 last:border-0">
                    <button
                      ...
                      className="w-full py-4 text-left font-bold text-sm text-gray-700 flex justify-between items-center"
                    >
                      {item.question}
                    ...
                    <div
                      className={`overflow-hidden transition-all duration-300 ${
                        openFaqIndex === i ? "max-h-40 pb-4" : "max-h-0"
                      }`}
                    >
          ...
          <div className="animate-in slide-in-from-right-8 duration-500">
            ...
            <div className="bg-white rounded-[2rem] p-6 shadow-xl border border-gray-100">
                ...
                <div className="space-y-4">
                  ...
                  <div className="relative" ref={dropdownRef}>
                    {loadingModelos && (
                      <div className="absolute right-4 top-4">
                        <Loader2 className="animate-spin text-[#f2e14c]" size={20} />
                      </div>
                    )}

                    <input
                      type="text"
                      placeholder="Qual o modelo? (Ex: Onix)"
                      value={modelSearch}
                      onChange={(e) => {
                    ...
                    {showModelList && filteredModels.length > 0 && (
                      <ul className="absolute z-20 w-full bg-white border border-gray-200 rounded-xl shadow-2xl max-h-60 overflow-y-auto mt-2">
                        {filteredModels.map((m) => (
                          <li
                            key={String(m.codigo)}
                            onClick={() => {
                              setFormData((prev) => ({ ...prev, modelo: m.nome }));
                              setModelSearch(m.nome);
                              setShowModelList(false);
                            }}
                            className="px-4 py-3 border-b border-gray-50 last:border-0 text-xs font-bold uppercase hover:bg-gray-50 cursor-pointer"
                          >
                            {m.nome}
                          </li>
                        ))}
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <input
                      ...
                      className="w-full p-4 bg-gray-50 rounded-xl border-2 border-transparent focus:bg-white focus:border-[#f2e14c] outline-none font-bold text-gray-900 text-sm"
                      value={formData.ano}
              ...
              <div className="mb-8">
                ...
                <div className="space-y-4">
                  <input
                    ...
                    className="w-full p-4 bg-gray-50 rounded-xl border-2 border-transparent focus:bg-white focus:border-[#f2e14c] outline-none font-bold text-gray-900 text-sm uppercase"
                    value={formData.nome}
                  ...
                  <div className="grid grid-cols-1 gap-4">
                    <input
                      ...
                      placeholder="CPF"
                      maxLength={14}
                      className="w-full p-4 bg-gray-50 rounded-xl border-2 border-transparent focus:bg-white focus:border-[#f2e14c] outline-none font-bold text-gray-900 text-sm font-mono"
                      value={formData.cpf}
              ...
              <div>
                <h3 className="text-xs font-black text-gray-400 uppercase mb-4 flex items-center gap-2">
                  <Wallet size={16} className="text-[#f2e14c]" /> 3. Financeiro{" "}
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    ...
                    <input
                      type="text"
                      placeholder="R$ 0,00"
                      className="w-full p-3 bg-gray-50 rounded-xl border-2 border-transparent focus:bg-white focus:border-[#f2e14c] outline-none font-bold text-gray-900 text-sm"
                  ...
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        setFormData({ ...formData, entrada: formatCurrency(e.target.value) })
                      }
                    />
                  </div>
                </div>
              ...
              {!canSubmit ? (
                <p className="mt-4 text-[10px] text-gray-400 uppercase tracking-widest font-bold">
                  Preencha: modelo, valor, nome, CPF e WhatsApp.
                </p>
              ) : null}
            </div>
          </div>
