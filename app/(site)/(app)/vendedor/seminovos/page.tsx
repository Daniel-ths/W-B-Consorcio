...
export default function SeminovosPage() {
  ...
  const filteredModels = useMemo(() => {
    const s = modelSearch.toLowerCase().trim();
    if (!s) return modelos;
  ...
  const handleBrandSelect = async (brand: any) => {
    ...
    try {
      ...
      const listaModelos = Array.isArray(data?.modelos) ? data.modelos : [];
  ...
  const handleSubmit = () => {
    const modeloFinal = (formData.modelo || modelSearch || "").trim();
      ...
      <main className="max-w-7xl mx-auto px-6 py-16 flex-grow w-full">
        <div className="text-center max-w-4xl mx-auto mb-20 animate-in fade-in slide-in-from-bottom-8 duration-700">
          ...
          <p className="text-gray-500 text-lg font-medium leading-relaxed max-w-2xl mx-auto">
            Compre e venda seu carro usado de forma segura e transparente de
            todas as marcas com a confiança da Rede Chevrolet. Aqui você
            encontra qualidade certificada.
          </p>
        </div>
              ...
              <div className="space-y-8">
                <div className="p-6 bg-gradient-to-r from-gray-50 to-white rounded-2xl flex items-center gap-6 border border-gray-100">
                  ...
                  <div>
                    ...
                    <p className="font-black text-3xl uppercase leading-none text-gray-900">
                      {selectedBrand.name}
                    </p>
                  </div>
                  <CheckCircle2
                    className="ml-auto text-green-500 hidden sm:block"
                    size={24}
                  />
                </div>
                ...
                <div className="relative group" ref={dropdownRef}>
                  ...
                  <p className="mt-2 text-[11px] text-gray-400 font-bold uppercase tracking-wide ml-1">
                    Você pode digitar o modelo manualmente ou selecionar uma sugestão.
                  </p>
                </div>
              ...
              <div className="space-y-5">
                ...
                <div className="pt-6 border-t border-gray-100 mt-6">
                  <h3 className="text-xs font-bold text-gray-700 uppercase mb-4 flex items-center gap-2 tracking-wide">
                    <Wallet size={14} className="text-[#f2e14c]" /> Perfil
                    Financeiro
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div className="relative group">
                      ...
                      />
                      <span className="absolute left-4 top-[34px] text-gray-400 font-bold text-xs">
                        R$
                      </span>
                    </div>
                ...
                >
                  Solicitar Análise{" "}
                  <ArrowRight size={20} className="text-[#f2e14c]" />
                </button>
        ...
        <div className="max-w-6xl mx-auto px-6 grid grid-cols-1 md:grid-cols-4 gap-12">
          <div className="col-span-2">
            ...
            <p className="text-xs leading-relaxed text-gray-400 max-w-sm font-medium">
              Plataforma de simulação de financiamento automotivo. Consultas
              integradas à Tabela FIPE e instituições financeiras parceiras.
            </p>
          </div>

          <div>
            <h4 className="font-black uppercase text-xs mb-6 text-gray-900 tracking-widest">
              Atendimento
            </h4>
