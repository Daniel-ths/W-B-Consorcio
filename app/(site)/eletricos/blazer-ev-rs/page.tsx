...
/**
 * Blazer EV RS — Landing + FINALIZAÇÃO NO FINAL
...
const CONFIG = {
  ...
  stats: [
    { value: "481", unit: "km", label: "de autonomia", icon: <BatteryCharging size={18} /> },
    { value: "~40", unit: "min", label: "até 80% da carga", icon: <PlugZap size={18} /> },
    { value: "347", unit: "cv", label: "Potência", icon: <Gauge size={18} /> },
    {
      value: "17,7",
      unit: '"',
      label: "Multimídia MyLink com Google integrado",
      icon: <MonitorSmartphone size={18} />,
    },
  ],

  heroImage:
    "https://qkpfsisyaohpdetyhtjd.supabase.co/storage/v1/object/public/cars/eletricos/22/chevrolet-blazer-ev-rs-2025-branco-abalone-frente-parado.webp",

  sectionImage:
    "https://qkpfsisyaohpdetyhtjd.supabase.co/storage/v1/object/public/cars/eletricos/22/capa/imagem-balzer-ev.avif",

  sectionTitle: "Além do DNA esportivo, um SUV 100% elétrico",
  sectionText:
    "O Blazer EV RS combina design marcante, tecnologia e uma condução silenciosa com torque imediato. Ideal para quem quer um elétrico moderno sem complicação no dia a dia.",

  gallery: [
    "https://qkpfsisyaohpdetyhtjd.supabase.co/storage/v1/object/public/cars/eletricos/22/galeria-05.avif",
    ...
    "https://qkpfsisyaohpdetyhtjd.supabase.co/storage/v1/object/public/cars/eletricos/22/galeria-03.avif",
    "https://qkpfsisyaohpdetyhtjd.supabase.co/storage/v1/object/public/cars/eletricos/22/galeria-04.avif",
    "https://qkpfsisyaohpdetyhtjd.supabase.co/storage/v1/object/public/cars/eletricos/22/galeria-06.avif",
  ],

  exterior: {
    trimLabel: "RS",
    headline: "Esportivo e 100% elétrico",
    colors: [
      {
        name: "Vermelho Radiant",
        hex: "#b11226",
        img: "https://qkpfsisyaohpdetyhtjd.supabase.co/storage/v1/object/public/cars/eletricos/22/vermelho.png",
      },
      {
        name: "Branco Abalone",
        hex: "#e9e9e9",
        img: "https://qkpfsisyaohpdetyhtjd.supabase.co/storage/v1/object/public/cars/eletricos/22/branco.png",
      },
      {
        name: "Cinza",
        hex: "#9aa3ad",
        img: "https://qkpfsisyaohpdetyhtjd.supabase.co/storage/v1/object/public/cars/eletricos/22/prata.png",
      },
      {
        name: "Preto",
        hex: "#1f2328",
        img: "https://qkpfsisyaohpdetyhtjd.supabase.co/storage/v1/object/public/cars/eletricos/22/preto%20global.png",
      },
    ],
  },
...
export default function BlazerEVRSPage() {
  ...
  const handleFinishOrder = async () => {
    ...
    if (!telefoneE164Digits) {
      newErrors.clientPhone = "Telefone inválido. Digite com DDD.";
      hasError = true;
    } else {
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                  ...
                  <div>
                    ...
                    <p className="text-[11px] text-gray-400 mt-1">
                      Dica: digite com DDD. Ex: <span className="font-mono">91 9XXXX XXXX</span>
                    </p>
                  </div>
              ...
              <div className="bg-gray-50 rounded-2xl p-6 border border-gray-200">
                ...
                <p className="text-[11px] text-gray-400 mt-4 italic">
                  * As taxas e coeficientes serão aplicados na próxima aba após a validação dos dados
                  acima.
                </p>
