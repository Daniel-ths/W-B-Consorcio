...
const CONFIG = {
  ...
  stats: [
    ...
    { value: "111", unit: "cv", label: "Potência", icon: <Gauge size={18} /> },
  ...
  exterior: {
    ...
    colors: [
      ...
      },
      {
        ...
        hex: "#1f2328",
        img: "https://qkpfsisyaohpdetyhtjd.supabase.co/storage/v1/object/public/cars/suv/spin/Preto%20Ouro%20Negro.png",
      },
    ],
  },
  ...
  benefits: [
    ...
    { icon: <MonitorSmartphone size={18} />, title: "Tecnologia", desc: "conectividade e praticidade" },
    { icon: <Wrench size={18} />, title: "Versatilidade", desc: "porta-malas e modularidade" },
  ],
};
