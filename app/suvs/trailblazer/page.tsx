 ...
 *
 * Trailblazer: specs ajustadas conforme release Chevrolet (Brasil).
 */
...
const CONFIG = {
  ...
  stats: [
    { value: "2.8", unit: "TD", label: "Turbodiesel", icon: <Settings size={18} /> },
    { value: "207", unit: "cv", label: "Potência", icon: <Gauge size={18} /> },
    { value: "52", unit: "kgfm", label: "Torque", icon: <CarFront size={18} /> },
    { value: "7", unit: "lug.", label: "Assentos", icon: <Users size={18} /> },
  ],

  // HERO (imagem oficial do release)
  heroImage: "https://qkpfsisyaohpdetyhtjd.supabase.co/storage/v1/object/public/cars/suv/Trailblazer/galeria-04.avif",

  // seção imagem + texto (dark)
  sectionImage: "https://qkpfsisyaohpdetyhtjd.supabase.co/storage/v1/object/public/cars/suv/Trailblazer/galeria-1.avif",
  sectionTitle: "SUV 4x4 de 7 lugares, pronto para qualquer terreno.",
  sectionText:
    "O Trailblazer combina robustez, capacidade fora de estrada e conforto para a família. Motor 2.8 Turbodiesel de 207 cv e 52 kgfm, com câmbio automático e tração 4x4.",

  // Galeria mosaico (6 imagens) — pode trocar pelas suas do Supabase
  gallery: [
    "https://qkpfsisyaohpdetyhtjd.supabase.co/storage/v1/object/public/cars/suv/Trailblazer/galeria-2.avif",
    "https://qkpfsisyaohpdetyhtjd.supabase.co/storage/v1/object/public/cars/suv/Trailblazer/galeria-3.avif",
    "https://qkpfsisyaohpdetyhtjd.supabase.co/storage/v1/object/public/cars/suv/Trailblazer/galeria-08.avif",
    "https://qkpfsisyaohpdetyhtjd.supabase.co/storage/v1/object/public/cars/suv/Trailblazer/galeria-06.avif",
    "https://qkpfsisyaohpdetyhtjd.supabase.co/storage/v1/object/public/cars/suv/Trailblazer/galeria-05.avif",
    "https://qkpfsisyaohpdetyhtjd.supabase.co/storage/v1/object/public/cars/suv/Trailblazer/galeria-11.avif",
  ],

  // ======= EXTERIOR (cores + imagem por cor) =======
  // (cores aqui são placeholders; troque pelas suas imagens)
  exterior: {
    trimLabel: "Chevrolet",
    ...
    colors: [
      {
        name: "Branco",
        hex: "#f4f4f4",
        img: "https://qkpfsisyaohpdetyhtjd.supabase.co/storage/v1/object/public/cars/suv/Trailblazer/Branco.png",
      },
      {
        name: "Preto",
        hex: "#2c3035",
        img: "https://qkpfsisyaohpdetyhtjd.supabase.co/storage/v1/object/public/cars/suv/Trailblazer/Preto%20Ouro%20Negro.png",
      },
      {
        name: "Cinza Topázio",
        hex: "#475663",
        img: "https://qkpfsisyaohpdetyhtjd.supabase.co/storage/v1/object/public/cars/suv/Trailblazer/Cinza%20Topazio.png",
      },
    ],
  },

  // ======= INTERIOR (cores + imagens em carousel por cor) =======
  // (placeholders; troque pelas suas imagens)
  interior: {
    trimLabel: "Interior",
    colors: [
      {
  ...
  benefits: [
    { icon: <CarFront size={18} />, title: "4x4 de verdade", desc: "pronto para qualquer rota" },
    { icon: <Settings size={18} />, title: "2.8 Turbodiesel", desc: "207 cv e 52 kgfm" },
    { icon: <ShieldCheck size={18} />, title: "SUV 7 lugares", desc: "espaço para toda família" },
    { icon: <FileText size={18} />, title: "Simulação guiada", desc: "do início ao fim" },
  ],
};
...
export default function TrailblazerElectricStylePage() {
  ...
  const interiorCurrent =
    interiorImages[interiorIndex] || interiorImages[0] || CONFIG.heroImage;
        ...
        <div className="max-w-[1400px] mx-auto px-4 md:px-10 py-14">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
            ...
            <div className="max-w-xl">
              ...
              <div className="mt-6 grid grid-cols-1 sm:grid-cols-2 gap-3 text-xs text-white/70">
                <div className="flex items-center gap-2">
                  <Settings size={16} className="text-white/60" />
                  Motor 2.8 Turbodiesel (207 cv)
                </div>
                <div className="flex items-center gap-2">
