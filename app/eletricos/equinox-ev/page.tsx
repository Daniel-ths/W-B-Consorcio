...
const CONFIG = {
  ...
  stats: [
    ...
    { value: "17,7", unit: '"', label: "MyLink + Google built-in", icon: <MonitorSmartphone size={18} /> },
  ],
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
              ...
              <div className="bg-gray-50 rounded-2xl p-6 border border-gray-200">
                ...
                <div className="mt-6 p-4 rounded-xl border border-gray-200 bg-white">
                  ...
                  <p className="text-xs text-gray-500 mt-2">
                    Entrada sugerida (30%): <span className="font-bold">{moneyBRL(buildAnaliseParams().entrada)}</span>
                  </p>
                </div>
              </div>
            </div>
